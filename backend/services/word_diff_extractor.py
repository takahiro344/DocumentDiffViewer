...
from backend.services.base_diff_extractor import BaseDiffExtractor


class WordDiffExtractor(BaseDiffExtractor):
    def extract(self) -> list[Diff]:
        ...
        content1 = self.file1.file.read()
        content2 = self.file2.file.read()
